...
public class PillsReminderFragment extends Fragment {
    ...
    private void initCards() {
        ...
        for (final PillReminder pillReminder : mPills){
            PillReminderCard card = new PillReminderCard(getActivity());
           // card.setResourceIdThumbnail(pillReminder.getmImage());
            card.setTitle(pillReminder.getmDescription());
            //card.setCard_pill_id(pillReminder.getmId());
            card.init();
